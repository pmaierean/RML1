 ...
 * When !DW is used without a parameter, the default value is applied (0
 * msec).
 * There is no wait time when the cutting direction changes.
...
public class DwellFormat extends RML1CommandFormat {
    public static final String NAME = "Dwell3";
    ...
    public String generateCommand(List<CommandArgument> arguments) throws Exception {
        ...
        if (arguments == null || arguments.size() == 0) {
            ...
            ret = String.format("!DW%s;", arguments.get(0).toString());
        }
        return ret;
    }
