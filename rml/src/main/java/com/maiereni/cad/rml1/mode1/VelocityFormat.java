 ...
 */
public class VelocityFormat extends RML1CommandFormat {
    public static final String NAME = "Set velocity for X and Y movements";
    public static final String PATTERN = "F(" + FLOAT_PATTERN + "|" + INT_PATTERN + ")?;";
    ...
    public String generateCommand(List<CommandArgument> arguments) throws Exception {
        ...
        if (arguments == null || arguments.size() == 0) {
            ...
            ret = String.format("F %s;", arguments.get(0).toString());
        }
        return ret;
    }
