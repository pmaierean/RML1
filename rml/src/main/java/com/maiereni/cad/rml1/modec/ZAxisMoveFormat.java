 ...
 * Movement to the Z-axis coordinate value specified by the z parameter is
 * performed.
 * The X and Y axes do not operate at that time.
 ...
 * When no parameter is present, no execution is performed.
 *
 * @author Petre Maierean
 */
public class ZAxisMoveFormat extends RML1CommandFormat {
    public static final String NAME = "Move on Z axis";
    public static final String PATTERN = "!ZM(" + FLOAT_PATTERN + ")?;";
    ...
    public String generateCommand(List<CommandArgument> arguments) throws Exception {
        ...
        if (arguments == null || arguments.size() == 0) {
            ...
            ret = String.format("!ZM %s;", arguments.get(0).toString());
        }
        return ret;
    }
