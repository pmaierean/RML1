 ...
 */
public class ThreeAxisFormat extends RML1CommandFormat {
    public static final String NAME = "Simultanous move on XYZ";
    public static final String PATTERN = "Z(" + THREE_FLOATS_PATTERN + "(\\x2c" + THREE_FLOATS_PATTERN + ")*" + ")?;";
    ...
    public String generateCommand(List<CommandArgument> arguments) throws Exception {
        ...
        for (CommandArgument argument : arguments) {
            ...
            VertexArgument pairOfFloatsArgument = (VertexArgument) argument;
